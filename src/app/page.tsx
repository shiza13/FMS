...
/>
 ...
 <section className="mb-8 p-8 bg-gray-100 py-20 mt-16" id="services">
  ...
  <div className="text-center mt-10 mb-8">
      <a href="/industries" className="inline-block px-6 py-2 rounded-md bg-[#001f4d] hover:bg-blue-900 igo-700 text-white text-base font-medium transition">
        Explore Products
      </a>
    </div>
</section>
  ...
  <div className="max-w-5xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg hover:ring-4 hover:ring-[#001f3f] group">
        <div className="bg-gray-50 aspect-[23/16]">
          <img src="/textiledye.png" alt="Textile Industry" className="w-full h-full object-cover" />
        </div>
        <div className="p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-3">Textile</h3>
          <p className="text-slate-600 text-sm leading-relaxed">Water-efficient solutions for textile processing and dyeing industries.</p>
        </div>
        <a href="/industries" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      </div>

      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg hover:ring-4 hover:ring-[#001f3f] group">
        <div className="bg-gray-50 aspect-[23/16]">
          <img src="/ultrapure.png" alt="Pharmaceuticals Industry" className="w-full h-full object-cover" />
        </div>
        <div className="p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-3">Pharmaceuticals</h3>
          <p className="text-slate-600 text-sm leading-relaxed">Purification systems to meet strict quality standards in pharma production.</p>
        </div>
        <a href="/industries" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg hover:ring-4 hover:ring-[#001f3f] group">
        <div className="bg-gray-50 aspect-[23/16]">
          <img src="/food.png" alt="Food and Beverages Industry" className="w-full h-full object-cover" />
        </div>
        <div className="p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-3">Food & Beverages</h3>
          <p className="text-slate-600 text-sm leading-relaxed">Ensuring safe, clean water for food and beverage manufacturing.</p>
        </div>
        <a href="/industries" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
...
<div className="p-6 bg-[#f0f4f8]">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-4xl font-bold text-slate-900 mb-10 text-center">Our Plants</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/reverseosmosis.png" alt="Reverse Osmosis System" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Reverse Osmosis System</h3>
          <p className="text-slate-600 text-sm">High-efficiency RO plants for pure water production in industrial applications.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      </div>

      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/textile.png" alt="Dye Purification System" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Dye Purification System</h3>
          <p className="text-slate-600 text-sm">Efficient treatment for textile dye wastewater to meet environmental standards.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/waterrecycle.png" alt="Wastewater Recycling" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Wastewater Recycling</h3>
          <p className="text-slate-600 text-sm">Minimizes effluent discharge by recycling water within industrial processes.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
...
<div className="p-6 bg-[#f0f4f8] mt-16">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-4xl font-bold text-slate-900 mb-10 text-center">Our Components</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">

      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/membranes.png" alt="Membranes" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Membranes</h3>
          <p className="text-slate-600 text-sm">High-quality membranes for efficient water purification and filtration.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/centrifugal pumps.png" alt="Centrifugal Pumps" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Centrifugal Pumps</h3>
          <p className="text-slate-600 text-sm">Reliable pumps for smooth operation in water and wastewater systems.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
      ...
      <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
        <img src="/pressure vessel.png" alt="Pressure Vessels" className="w-full h-48 object-cover" />
        <div className="p-6">
          <h3 className="text-xl font-semibold text-slate-900 mb-2">Pressure Vessels</h3>
          <p className="text-slate-600 text-sm">Durable pressure vessels designed for high-performance water treatment systems.</p>
        </div>
        <a href="/plants-components" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition">
          <span className="px-4 py-2 bg-[#001f4d] text-white rounded-md font-medium">Explore</span>
        </a>
