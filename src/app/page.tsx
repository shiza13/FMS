        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              At <span className="font-semibold">Fluid Management Service (FMS)</span>, we specialize
              in total water and waste management solutions. Our mission is to help industries reduce
              water usage, recycle effluents, and adopt sustainable practices that keep them green and
              competitive.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  High-efficiency RO plants for pure water production in
            ...
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Efficient treatment for textile dye wastewater to meet
            ...
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl group hover:ring-4 hover:ring-[#001f4d]">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Minimizes effluent discharge by recycling water within
